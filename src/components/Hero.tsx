...
export default function Hero() {
  ...
  return (
    <section className="relative w-full overflow-hidden min-h-[90vh] flex flex-col items-center justify-center">
      <Scene3D />
      <div className="relative z-10 max-w-7xl mx-auto px-8 py-20 lg:py-32 flex flex-col items-center text-center">
